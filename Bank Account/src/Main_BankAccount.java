...
public class Main_BankAccount {
	...
	public static void main(String[] args) {
		...
		Account JuhosAccount2 = new Account("Juho", "Juho@email.com", "12345");
		System.out.println(JuhosAccount2.getNumber() + " Name: " + JuhosAccount2.getCustomerName());
		System.out.println("Current balance is " + JuhosAccount2.getBalance());
		JuhosAccount2.withdrawal(100.55);
